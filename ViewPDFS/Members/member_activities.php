...
$stud = mysqli_query($conn, "SELECT * FROM members WHERE member_id='$getMemberID' AND member_id_encrypt='$getMemberIDEncrypt' AND active='yes' LIMIT 1 ");
...
class PDF extends FPDF {
	function Header(){
		...
		$this->Cell(180,10,'MEMBER ACTIVITIES   ',0,1,'C');
...
$sle = mysqli_query($conn, "SELECT * FROM members_activities WHERE member_id='$getMemberID' AND active='yes'");
