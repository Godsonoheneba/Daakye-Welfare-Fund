...
class PDF extends FPDF {
	function Header(){
		...
		$this->Cell(180,10,'ALL DEACTIVATED MEMBERS  FROM ' . $MINDATE . '  -  ' . $MAXDATE,0,1,'C');
		...
		$this->Cell(40,10,' 5% Amount Deduction ',1,0,'C',true);
...
$selectAllMEmbers = mysqli_query($conn, "SELECT * FROM comp_reve_5_perc_mem_deactivate_deduction WHERE active ='yes' AND 
	date_added
...
$pdf->Cell(180,10, 'TOTAL 5% Deduction :  GHC '  . number_format($TOTAL, 2), 1,1, 'C');
