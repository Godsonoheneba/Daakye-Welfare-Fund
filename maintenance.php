...
<head>
  ...
  <!-- Begin SEO tag -->
  <title> DAAKYE WELFARE FUND | PAGE UNDER MAINTENEAMCE </title>
    ...
    <main class="auth">
      ...
      <div class="empty-state">
        ...
        <div class="empty-state-container">
                ...
                <div class="form-group w-75 mx-auto">
                  ...
                  <div class="input-group input-group-lg circle">
                    ...
                    <div class="input-group-append">
                      <button type="submit" class="btn btn-reset text-primary px-3"><i class="fa fa-arrow-circle-right text-primary"></i></button>
                    </div>
                  </div>
                </div>
              </form> -->
          ...
          <p class="text-muted small"> Daakye Welfare Fund | Page Under Maintainance, Please come back in no time | Thank you</p>
