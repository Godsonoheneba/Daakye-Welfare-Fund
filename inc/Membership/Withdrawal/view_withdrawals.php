...
if ($login_session_type==="3" || $login_session_type==="1") {
  ...
  <header class="page-title-bar">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item active">
          <a href="#"><i class="breadcrumb-icon fa fa-angle-left mr-2"></i>Withdrawals</a>
        </li>
      </ol>
    </nav><!-- /.breadcrumb -->
    <!-- floating action -->
    ...
    <div class="d-md-flex align-items-md-start">
      <h1 class="page-title mr-sm-auto"> All Withdrawals </h1><!-- .btn-toolbar -->
  ...
  <div class="list-group list-group-flush list-group-divider border-top" data-toggle="radiolist">
    <div class="card card-fluid">
        ...
        <div class=" table-responsive">
          ...
          <table class="table">
            ...
            $selCon = mysqli_query($conn, "SELECT mem.*, conw.*  FROM members mem, contributions_withdrawal conw WHERE
              mem.member_id_encrypt = conw.member_id
              AND conw.active ='yes' 
              AND conw.status ='0' 
              AND mem.active ='yes' 

             ORDER BY conw.id DESC 

             ");

            if (mysqli_num_rows($selCon)!==0) {

              while ( $getAlls = mysqli_fetch_assoc($selCon)) {
                ...
                <tbody class="getsearch" data-toggle="sidebar" data-sidebar="show">
                  ...
                  <tr>
                    ...
                    <td class="align-middle"> <?php echo $total_contribution_made ?> </td>
                    ...
                    <td class="align-middle text-center">
                     <div class="btn-group btn-group-toggle" data-toggle="buttons">
                        ...
                        <label class="btn btn-secondary" onclick="issueWithdrawal('<?php echo $id ?>','<?php echo $member_id_encrypt ?>','<?php echo $amount ?>','<?php echo $fullname ?>','<?php echo $telephone ?>') ">

                          <input type="radio" name="options" id="option1" checked > Issue</label> 
                          ...
                          <label class="btn btn-secondary" onclick="window.location.href='homepage.php?CHECKER=EDIT_MEMBER_INFO&&DACO=<?php echo $member_id ?>&&TRUE=<?php echo $member_id_encrypt ?>' ">
                            ...
                            <input type="radio" name="options" id="option2"> Denied</label> 
      ...
      <script type="text/javascript">
        ...
        function issueWithdrawal(tabId,member_id_encrypt,amount,fullname,telephone) {



          Swal.fire({
            title: 'Are you sure you want to Issue ' + amount + '.00  As withdrawal to ' +fullname + ' ? ' ,
            ...
            if (result.value) {
              ...
              $.post(".esgapehtllaroftsopxajaehtsitaht..ajaxpost?CHECKPOST=issueWithdrawalPost",{tabId:tabId,telephone:telephone,member_id_encrypt:member_id_encrypt,fullname:fullname},function (showOutPut) {
