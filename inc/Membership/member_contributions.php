...
<div class="page">
 ...
 <a class="nav-link " href="homepage.php?CHECKER=VIEW_MEMBER_INFO&&DACO=<?php echo $member_id ?>&&TRUE=<?php echo $member_id_encrypt ?> "> Overview</a> 
      ...
      <a class="nav-link active" href="homepage.php?CHECKER=VIEW_MEMBER_CONTRIBUTIONS&&DACO=<?php echo $member_id ?>&&TRUE=<?php echo $member_id_encrypt ?> ">Contributions</a>
    ...
    <div class="row">
      ...
      <div class="col-lg-4">
        ...
        <div class="card card-fluid">
          <h6 class="card-header"> All Contributions for <?php echo $fullname ?>  </h6><!-- .nav -->
          <nav class="nav nav-tabs flex-column border-0">
            <a  class="nav-link active">Contributions Summary</a>
            ...
            <table class="table">
              ...
              $selectDis = mysqli_query($conn, "SELECT DISTINCT  year FROM members_contributions WHERE member_id='$member_id'  AND active='yes' ORDER BY year DESC ");
              ...
              while ($getRow2 = mysqli_fetch_assoc($selectDis)) {
                ...
                $selectSum1 = mysqli_query($conn, "SELECT SUM(amount) AS amount FROM members_contributions WHERE member_id='$member_id'  AND active='yes' AND year='$getPaidyear' ");

                $getRow55 = mysqli_fetch_assoc($selectSum1);
                $totalContributionforthatyear = $getRow55["amount"];


                $countCOnti = mysqli_query($conn, "SELECT count(*) AS count1 FROM members_contributions WHERE member_id='$member_id'  AND active='yes' AND year='$getPaidyear'  ");
