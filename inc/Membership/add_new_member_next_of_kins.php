<div class="theHolderForAllNextOfKins" >
  


        <!-- -------------------------- FOR NEXT OF KINS 1------------------------------------ -->
        
        <div class="row form-group col-md-12 mb-3 nextOFKinHolderDivCLassFOr1" style="display: none;">
        ...
        <div class="row form-group col-md-12 mb-3 nextOFKinHolderDivCLassFOr2" style="display: none;">
        ...
        <!-- --------------------------FOR NEXT OF KINS 3------------------------------------ -->
         ...
         <div class="row form-group col-md-12 mb-3 nextOFKinHolderDivCLassFOr3" style="display: none;">
        ...
        <!-- --------------------------FOR NEXT OF KINS 4------------------------------------ -->
         ...
         <div class="row form-group col-md-12 mb-3 nextOFKinHolderDivCLassFOr4" style="display: none;">
        ...
        <!-- --------------------------FOR NEXT OF KINS 5------------------------------------ -->
         ...
         <div class="row form-group col-md-12 mb-3 nextOFKinHolderDivCLassFOr5" style="display: none;">
        ...
        <!-- --------------------------FOR NEXT OF KINS 6------------------------------------ -->
         ...
         <div class="row form-group col-md-12 mb-3 nextOFKinHolderDivCLassFOr6" style="display: none;">
  ...
  <!-- --------------------------FOR NEXT OF KINS 7------------------------------------ -->
         ...
         <div class="row form-group col-md-12 mb-3 nextOFKinHolderDivCLassFOr7" style="display: none;">
  ...
  <!-- --------------------------FOR NEXT OF KINS 8------------------------------------ -->
         ...
         <div class="row form-group col-md-12 mb-3 nextOFKinHolderDivCLassFOr8" style="display: none;">
  ...
  <!-- --------------------------FOR NEXT OF KINS 9------------------------------------ -->
         ...
         <div class="row form-group col-md-12 mb-3 nextOFKinHolderDivCLassFOr9" style="display: none;">
  ...
  <!-- --------------------------FOR NEXT OF KINS 10------------------------------------ -->
         ...
         <div class="row form-group col-md-12 mb-3 nextOFKinHolderDivCLassFOr10" style="display: none;">
