...
<div class="page-inner">
  ...
  <header class="page-title-bar"> 
    ...
    <h1 class="page-title">  Contribution Deduction</h1>
    ...
    <div class="card card-fluid">
      ...
      <div class="col-lg-12">
       ...
       <div class="section-block text-center text-sm-left " style="margin: 30px!important;">
        ...
        <a data-toggle="modal" data-target="#depositModal">
          <div class="visual-picker visual-picker-lg has-peek text-center " style="margin: 50px!important;">
            ...
            <label class="visual-picker-figure" for="vpr05">
              ...
              <span class="visual-picker-content"><span class="h3 d-block">DEDUCT </span> 
            </div><!-- /.visual-picker -->
          </a>
              ...
              <!-- .visual-picker -->
              <a style="cursor: pointer;" onclick="window.location.href='homepage.php?CHECKER=VIEW_MEMBER_DEDUCTIONS&&DACO=<?php echo $member_id ?>&&TRUE=<?php echo $member_id_encrypt ?>'  ">
                <div class="visual-picker visual-picker-lg has-peek text-center" style="margin: 50px!important;">
                  <!-- visual-picker input -->
                  <input type="radio" id="vpr09" name="vprLG"> <!-- .visual-picker-figure -->
                  <label class="visual-picker-figure" for="vpr09">
                    <!-- .visual-picker-content -->
                    <span class="visual-picker-content"><span class="h3 d-block">VIEW DEDUCTIONS</span> 
                  </div><!-- /.visual-picker -->
                </a>
        ...
        include 'deduct_contribution_modal.php';
