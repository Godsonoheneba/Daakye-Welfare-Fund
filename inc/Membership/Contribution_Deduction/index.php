...
<div class="page-inner">
  ...
  <header class="page-title-bar"> 
    ...
    <h1 class="page-title"> Deduct Contribution  </h1>
...
<script type="text/javascript">
  ...
  function searchMemberForIt() {
    ...
    if (seachresultInput!=="") {
      ...
      $.post(".esgapehtllaroftsopxajaehtsitaht..ajaxpost?CHECKPOST=searchMemberDedcutbyLivePost" , {seachresultInput:seachresultInput},function (showOutput) {
