...
<div class="board p-0 perfect-scrollbar" >
      ...
      <div class="card-body">
        <div class=" table-responsive">
          ...
          <table class="table">
            ...
            $selectCust = mysqli_query($conn, "SELECT * FROM company_expenses WHERE active ='yes' AND year_finish='no'  ORDER BY id DESC ");
  ...
  include 'add_new_expenses_modal.php'; 
