...
$countAllStu = mysqli_query($conn, "SELECT count(*) AS countAl FROM loans_all WHERE active='yes' AND loan_status='issued' ");
...
$countMale = mysqli_query($conn, "SELECT count(*) AS CountMa FROM loans_all WHERE status='$Customer' AND active='yes' AND loan_status='issued' ");

$countFetchMa = mysqli_fetch_array($countMale);
$countTotalLoansMale = $countFetchMa['CountMa'];


$countFeMale = mysqli_query($conn, "SELECT count(*) AS CountFe FROM loans_all WHERE status='$Member' AND active='yes' AND loan_status='issued' ");
    ...
    <div class="page-inner">
      ...
      <header class="page-title-bar">
        ...
        <div class="row text-center text-sm-left">
          ...
          <!-- grid column -->
          <div class="col">
            <h1 class="page-title"> All Loans Collected</h1>
        ...
        <div class="nav-scroller border-bottom">
          ...
          <div class="nav nav-tabs">
            ...
            <a class="nav-link active" href=".login-success.view-al-loans.js.kt.json.java">Overview</a> 

             <a class="nav-link" href="homepage.php?CHECKER=VIEW_LOANS_COLLECTED_BY_TYPE&&TRUE=<?php echo $ViewAllLoansID ?> ">All</a> 
             <a class="nav-link" href="homepage.php?CHECKER=VIEW_LOANS_COLLECTED_BY_TYPE&&TRUE=<?php echo $ViewMemberLoansID ?> ">Member</a> 
             <a class="nav-link" href="homepage.php?CHECKER=VIEW_LOANS_COLLECTED_BY_TYPE&&TRUE=<?php echo $ViewCUstomerLoansID ?> ">Customer</a> 
