...
<div class="page">
 ...
 <a class=\"nav-link \" href=\"homepage.php?CHECKER=VIEW_STAFF_INFO&TRUE=$encrypted_id \">Overview</a> 
 <a class=\"nav-link \" href=\"homepage.php?CHECKER=VIEW_STAFF_ACTIVITIES&TRUE=$encrypted_id \">Activities <span class=\"badge\">16</span></a> 
 <a class=\"nav-link active\" href=\"homepage.php?CHECKER=STAFF_SETTINGS&TRUE=$encrypted_id \">Settings</a>
        ...
        <div class="card card-fluid">
          ...
          <nav class="nav nav-tabs flex-column border-0">
            ...
            if ($confirm==="yes") {
             ...
             ?>
             <a style="cursor: pointer;" onclick="confirmStaff('<?php echo $staffID ?>')"class="nav-link">Confirm</a> 
             <?php
           }
           ...
           ?>
           <a  href="#" data-toggle="modal" data-target="#changeEmploymentType" class="nav-link">Change Employee Type</a> 
