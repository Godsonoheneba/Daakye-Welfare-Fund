  ...
  <div class="modal-dialog modal-dialog-scrollable" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        <center> <h6 id="moreStaffInfoLabel" class="modal-title text-center"> Change Personal Password  for : <?php echo $fullname ?> </h6></center>
     </div><!-- /.modal-header -->
     <!-- .modal-body -->
    ...
    <div class="modal-footer">
      <button type="button" class="btn btn-success" onclick="changePassword('<?php echo $tableIDSSSS ?>')">Change</button>
