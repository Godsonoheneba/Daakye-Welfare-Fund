...
<div class="page">
 ...
 <div class="page-inner">
  ...
  <div class="page-section">
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <div class="card card-fluid">
          ...
          <nav class="nav nav-tabs flex-column border-0">
           ...
           <a  href=".home.settings-member-interest.config.ruby.java.html" class="nav-link active">Member Interest Config</a>
      ...
      <div class="col-lg-9">
        <!-- .card -->
        <div class="card card-fluid">
          <h6 class="card-header"> Member Interest</h6><!-- .card-body -->
          <h6 class="card-header"> Click on the add Button to add Member Interest </h6><!-- .card-body -->
                    ...
                    <div class="card-body">
                      <div class=" table-responsive">
                        ...
                        <table class="table">
                          ...
                          <thead>
                            <tr class="text-cente align-middle">
                              ...
                              <th> Normal Interest Rate Amount </th>
                               <th >Defaulter Interest Rate </th>
                              <th> Defaulter Interest Rate Amount </th>
                              <th>  </th>
                            </tr>
                          </thead><!-- /thead -->
                          <!-- tbody -->
                          ...
                          $sel = mysqli_query($conn, "SELECT * FROM member_interest WHERE active = 'yes' ORDER BY id DESC LIMIT 1  ");


                          while ($gett= mysqli_fetch_assoc($sel)) {

                            $id = $gett["id"];
                            $one_to_twelve_month = $gett["one_to_twelve_month"];
                            $one_to_twelve_month_decimal = $gett["one_to_twelve_month_decimal"];
                            $more_than_twelve_month = $gett["more_than_twelve_month"];
                            $more_than_twelve_month_decimal = $gett["more_than_twelve_month_decimal"];
                            ...
                            ?> 
                              ...
                              <tr class="align-middle">
                                ...
                                <td class="align-middle">
                                   <span class="badge badge-subtle badge-success" style="font-size: 20px;"><?php echo $one_to_twelve_month ?>%</span>
                                </td>

                                <td class="align-middle">
                                   <span class="badge badge-subtle badge-primary" style="font-size: 20px;"><?php echo $one_to_twelve_month_decimal ?></span>
                                </td>



                                  <td class="align-middle">
                                    <span class="badge badge-subtle badge-success" style="font-size: 20px;"><?php echo $more_than_twelve_month ?>%</span>
                                  </td>


                                  <td class="align-middle">
                                    <span class="badge badge-subtle badge-warning" style="font-size: 20px;"><?php echo $more_than_twelve_month_decimal ?></span>
                                  </td>
                                ...
                                <td class="align-middle text-center">
                                 ...
                                 <div class="btn-group btn-group-toggle" data-toggle="buttons" onclick="deleteMemberInteresrRate('<?php echo $id ?>')">
  ...
  include 'add_member_interest_modal.php';
