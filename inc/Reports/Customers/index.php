    ...
    $selectMinDate = mysqli_query($conn, "SELECT date_created FROM customers WHERE active='yes' ORDER BY id ASC ");
    ...
    <div class="row">
      ...
      <center>
        ...
        <div class="form-actions col-md-12 mb-3">
         ...
         <button  type="submit" name="dd" class="btn btn-primary generateBut" onclick="generateAllCustoemrsLisBySelection()"> Generate  
         </button>
...
<script type="text/javascript">
  ...
  function generateAllCustoemrsLisBySelection() {
    ...
    if (fromDate!=="" && toDate!=="") {
      ...
      if (fromDate <= toDate) {
        ...
        $.post(".esgapehtllaroftsopxajaehtsitaht..ajaxpost?CHECKPOST=getCustoemrListReportsPost",{fromDate:fromDate,toDate:toDate},function (showOutPut) {
