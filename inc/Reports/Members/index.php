    ...
    $selectMinDate = mysqli_query($conn, "SELECT date_created FROM members WHERE active='yes' ORDER BY id ASC ");
    ...
    <div class="row">
      ...
      <center>
        ...
        <div class="form-actions col-md-12 mb-3">
         ...
         <button  type="submit" name="dd" class="btn btn-primary generateBut" onclick="generateAllMemberLisBySelection()"> Generate  
         </button>
...
<script type="text/javascript">
  ...
  function generateAllMemberLisBySelection() {
    ...
    if (fromDate!=="" && toDate!=="") {
      ...
      if (fromDate <= toDate) {
        ...
        $.post(".esgapehtllaroftsopxajaehtsitaht..ajaxpost?CHECKPOST=getMemberListReportsPost",{fromDate:fromDate,toDate:toDate},function (showOutPut) {
