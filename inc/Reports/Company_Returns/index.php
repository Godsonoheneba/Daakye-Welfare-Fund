  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      <li class="breadcrumb-item active">
        <a href="#"><i class="breadcrumb-icon fa fa-angle-left mr-2"></i>Company Returnship</a>
      </li>
    </ol>
  </nav><!-- /.breadcrumb -->
    ...
    <div class="row">
      ...
      <center>
        ...
        <div class="form-actions col-md-12 mb-3">
         ...
         <button  type="submit" name="dd" class="btn btn-primary generateBut" onclick="generateAllCompanyReturs()"> Generate  
         </button>
...
<script type="text/javascript">
  ...
  function generateAllCompanyReturs() {
    ...
    if (fromDate!=="" && toDate!=="") {
      ...
      if (fromDate <= toDate) {
        ...
        $.post(".esgapehtllaroftsopxajaehtsitaht..ajaxpost?CHECKPOST=getCompanyReturnRepots",{fromDate:fromDate,toDate:toDate},function (showOutPut) {
